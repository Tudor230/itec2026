const featureBlocks = [
  {
    ...
    body: 'Presence-aware editing keeps contributors aligned in the same session context, with workspace structure designed for multi-user visibility.',
    kicker: 'Collaboration',
  },
  {
    title: 'AI-Assisted Iteration',
    body: 'Planned right-side AI workspace patterns support inline refinement loops without leaving the coding surface or losing project context.',
    kicker: 'AI Workspace',
  },
  {
    title: 'Execution Feedback Loop',
    body: 'Run and debug controls are evolving into a dedicated workspace flow where edits, execution status, and logs stay in one place.',
